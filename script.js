...
2. SELL THE CROWD'S GREED: Selling calls is routine — harvest premium from mispriced optimism to fund insurance. But be thoughtful: confirm call sells where the risk/reward probability is clearly in our favor — good strike cushion, meaningful premium, proper sizing. Reject call sells where the premium is thin relative to the risk, the strike is too close to spot, or margin can't absorb an adverse move.
