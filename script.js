...
2. SELL IRRATIONAL PAYOUTS: Only sell calls when the crowd's greed makes the premium too handsome to ignore. This isn't routine theta harvesting — it's exploiting mispriced optimism. Confirm call sells when the premium is irrational relative to the actual probability, the strike gives real cushion, and exposure is sized to survive the worst case. Reject call sells where the premium doesn't justify the risk — if the payout isn't clearly irrational, don't take the other side.
